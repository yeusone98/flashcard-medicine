        ...
        <main className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-2xl flex-col px-4 py-8">
            <div className="mb-4 flex items-center gap-2">
                ...
                <h1 className="text-lg font-semibold tracking-tight">
                    Import Q/A Flashcards (.docx)
                </h1>
            </div>

            <Card className="bg-card">
                <CardHeader>
                    <CardTitle className="text-base">Import Q/A</CardTitle>
                    <CardDescription className="text-xs md:text-sm">
                        File .docx định dạng Q: / A: sẽ được chuyển thành flashcard hỏi –
                        đáp.
                    </CardDescription>
                </CardHeader>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                placeholder="VD: Bộ flashcard Q/A ôn tập huyết áp..."
                            />
                        </div>
